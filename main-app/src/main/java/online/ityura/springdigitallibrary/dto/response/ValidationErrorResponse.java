...
public class ValidationErrorResponse extends BaseDto {
    ...
    @Schema(description = "Ошибки валидации по полям", example = "{\"title\":\"Title is required\",\"value\":\"Value must be between 1 and 10\"}")
    private Map<String, String> fieldErrors;
    
    @Schema(description = "Временная метка ошибки", example = "2025-12-17T13:20:00Z")
    private Instant timestamp;
    
    @Schema(description = "Путь запроса", example = "/api/v1/books/1/ratings")
    private String path;
}
